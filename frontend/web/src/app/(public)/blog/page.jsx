...
export default function CreatePost1({
  ...
  saveAsDraftButtonText = "Salvar como rascunho",
  publishPostButtonText = "Publicar post",
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex justify-start space-x-4 pt-4">
                <Button type="button" variant="outline">
                  {saveAsDraftButtonText}<Save />
                </Button>
                <Button type="submit">{publishPostButtonText} <Send /></Button>
              </div>
            </form>
          </Form>
        </CardContent>
