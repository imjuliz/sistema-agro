...
export default function FuncionariosFazenda() {
  ...
  const loadFuncionarios = async () => {
    ...
    try {
      ...
      console.error("[FuncionariosLoja] Erro ao carregar funcionários:", error);
    } finally {
  ...
  const submitInvite = async () => {
    ...
    try {
      ...
      console.error('[FuncionariosLoja] submitInvite error', err);
    } finally {
  ...
  const isGerenteLoja = _userRole === 'GERENTE_LOJA' || _userRole === 'GERENTE_FAZENDA';
