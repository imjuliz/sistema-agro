  ...
  return (
    <div className="flex gap-6">
      <div className="flex-1 min-w-0 space-y-4">
              ...
              <PopoverContent side="bottom" align="start" className="w-[320px] p-3">
                ...
                <div className="space-y-3">
                      ...
                      {["GERENTE_FAZENDA", "FUNCIONARIO_FAZENDA"].map(t => (
                        <label key={t} className="flex items-center justify-between px-2 py-1 rounded hover:dark:bg-neutral-900 hover:bg-neutral-100 cursor-pointer">
                          <div className="flex items-center gap-2">
                            ...
                            <Transl className="capitalize text-sm">{t === "GERENTE_FAZENDA" ? "Gerente" : "Funcionário"}</Transl>
                          </div>
                          <Transl className="text-sm text-neutral-400">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    <Button size="sm" onClick={() => { applyFilters(); setPage(1); setPopoverOpen(false); }}><Transl>Aplicar</Transl></Button>
                    <Button size="sm" variant="ghost" onClick={() => { resetFilters(); setPopoverOpen(false); }}><Transl>Limpar</Transl></Button>
                  </div>
                </div>
              </PopoverContent>
            </Popover>
        ...
        {loadingFuncionarios ? (
          <Transl className="text-center py-8 text-muted-foreground">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select value={editingData.role} onValueChange={(v) => setEditingData(prev => ({ ...prev, role: v }))} className="col-span-3">
                ...
                <SelectContent>
                  <SelectItem value="GERENTE_FAZENDA"><Transl>Gerente</Transl></SelectItem>
                  <SelectItem value="FUNCIONARIO_FAZENDA"><Transl>Funcionário</Transl></SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
      ...
      <Dialog open={isInviteModalOpen} onOpenChange={setIsInviteModalOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            <DialogTitle><Transl>Convidar Usuário</Transl></DialogTitle>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="invite-telefone" className="text-right"><Transl>Telefone</Transl></Label>
