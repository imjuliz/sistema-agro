...
export default function Page() {
  return (
    <div className="flex flex-1 flex-col p-10 dark:bg-black">
      ...
      <div className="flex justify-between items-start gap-8 w-full mb-5">
      ...
      <div className="flex justify-between items-start gap-8 w-full">
        <div className="flex-[0.7] border-gray-200"><GraficoDeBarras /></div>
        <div className="flex-[0.3] flex justify-end "><CalendarEventListDemo /></div>
      </div>
       <div className="flex justify-between items-start gap-8 w-full">
        <div className="flex-[0.6] flex justify-end "><TweetGrid /></div>
        <div className="flex-[0.4] flex flex-col justify-end mt-10"><div className="mb-12"><SectionCards3/></div> <TableDemo/></div>
      </div>
    </div>
  )
}
