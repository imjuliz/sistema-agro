...
export function SectionCards() {
  return (
    <div
      ...
      <Card className="@container/card">
        <CardHeader>
          <CardDescription>Gastos diários</CardDescription>
      ...
      <Card className="@container/card">
        <CardHeader>
          ...
          <CardAction>{/* <Badge variant="outline"><IconTrendingUp />5</Badge> */}</CardAction>
        </CardHeader>
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <div className="line-clamp-1 flex gap-2 font-medium">Verifique a caixa de notificações <IconTrendingUp className="size-4" />
          </div>
