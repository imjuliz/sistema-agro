...
export function EquipeTab({ lojaId }) {
  ...
  const [typeFilters, setTypeFilters] = useState({ Gerente: true, "Funcionário": true });
  ...
  const resetFilters = () => {
    setQuery('')
    setLocationQuery('')
    setTypeFilters({ Gerente: true, "Funcionário": true })
      ...
      <div className="flex-1 min-w-0 space-y-4">
        ...
        {abrirModalEditar && usuarioSelecionado && (
          <EditarUsuarioModal
            ...
            onOpenChange={setAbrirModalEditar}
            onSuccess={() => {
