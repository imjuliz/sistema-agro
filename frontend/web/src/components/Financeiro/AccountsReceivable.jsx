...
interface AccountsReceivableProps {
  ...
  categories: Category[];
  onAccountsChange: (accounts: AccountReceivable[]) => void;
}
...
export function AccountsReceivable({ accounts, categories, onAccountsChange }: AccountsReceivableProps) {
    ...
    for (let i = 0; i < rows.length; i++) {
      ...
      try {
        ...
        const newAccount = {
          ...
          status: paymentDate ? 'received' : 'pending'
        };
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Selecione o mês e ano para filtrar as contas a receber
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {filteredAccounts.filter(acc => acc.status === 'received').length} contas
            </p>
          </CardContent>
        </Card>
              ...
              <TableBody>
                {filteredAccounts.map(account => (
                  <TableRow key={account.id}>
                    ...
                    <TableCell>
                      <Badge variant={account.status === 'received' ? 'default' : 'secondary'}>
                        {account.status === 'received' ? 'Recebida' : 'Pendente'}
                      </Badge>
                    </TableCell>
                    <TableCell>
                      <div className="flex items-center gap-2">
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Modifique os dados da conta a receber
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
