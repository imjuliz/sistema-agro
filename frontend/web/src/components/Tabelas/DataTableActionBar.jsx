...
export function DataTableActionBar({ table, visible: visibleProp, portalContainer: portalContainerProp, children, className, ...props }) {
  ...
  // **Aqui**: visibilidade por padrão quando TODOS os rows filtrados estão selecionados
  const visible = visibleProp ?? table.getIsAllRowsSelected();
...
export function DataTableActionBarAction({ size = "sm", tooltip, isPending, disabled, className, children, ...props }) {
  const trigger = (
    <Button
      variant="secondary"
      size={size}
...
export function DataTableActionBarSelection({ table }) {
