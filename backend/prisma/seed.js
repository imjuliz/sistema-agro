...
async function main() {
    try {
        ...
        const unidadesData = [
            ...
            { nome: "Fazenda Beta", endereco: "Rod. BR-101, km 123, Zona Rural, São Paulo - SP", tipo: TU.FAZENDA, areaTotal: 150.5, areaProdutiva: 120.3, cidade: "São Paulo", estado: "SP", cep: "01000-000", latitude: -21.347821, longitude: -48.736502 },
        ];
